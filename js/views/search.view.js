...
define(["backbone", "tmpls", "entities/worker", "utils/indexer", "views/suggestions.view", "views/indexation.view", "views/results.view"], function (Backbone, tmpls, worker, indexer, SuggestionsView, IndexationView, ResultsView) {
	var SUGGESTIONS_COUNT = 5;
	var MIN_QUERY_LEN_FOR_SUGGESTION = 3;
...
//# sourceMappingURL=../views/search.view.js.map